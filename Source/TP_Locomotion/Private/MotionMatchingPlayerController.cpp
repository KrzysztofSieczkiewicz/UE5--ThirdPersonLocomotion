#include "MotionMatchingPlayerController.h"
...
void AMotionMatchingPlayerController::OnPossess(APawn* aPawn)
{
	...
	// Get a reference LocalPlayer subsystem
	...
	if (ActionMove)
	{
		EnhancedInputComponent->BindAction(ActionMove, ETriggerEvent::Triggered, this,
			&AMotionMatchingPlayerController::HandleMoveTriggered);
		EnhancedInputComponent->BindAction(ActionMove, ETriggerEvent::Completed, this,
			&AMotionMatchingPlayerController::HandleMoveCompleted);
	}
	// ...
...
void AMotionMatchingPlayerController::HandleMoveTriggered(const FInputActionValue& InputActionValue)
{
...
void AMotionMatchingPlayerController::HandleMoveCompleted(const FInputActionValue& InputActionValue)
{
}
